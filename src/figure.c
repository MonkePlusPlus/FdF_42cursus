...
void	create_square(t_var var, t_data *pixel, t_pos *pos)
{
	...
	create_line(var, pixel, double_pos(posa, pos[0]));
	create_line(var, pixel, double_pos(posa, pos[1]));
	create_line(var, pixel, double_pos(posb, pos[0]));
	create_line(var, pixel, double_pos(posb, pos[1]));
}